...
clean_name_map = r"""  const nameMap: Record<string, string> = {
    '2330.TW': '\u53f0\u7a4d\u96fb', '2317.TW': '\u9d3b\u6d77', '2454.TW': '\u806f\u767c\u79d1', '2308.TW': '\u53f0\u9054\u96fb', 
    '2303.TW': '\u806f\u96fb', '2382.TW': '\u5ee3\u9054', '3711.TW': '\u65e5\u6708\u5149\u6295\u63a7', '2412.TW': '\u4e2d\u83ef\u96fb', 
    '2881.TW': '\u5bcc\u90a6\u90d1', '2882.TW': '\u570b\u6cf0\u90d1', '1301.TW': '\u53f0\u5851', '1303.TW': '\u5357\u4e9e', 
    '2886.TW': '\u5146\u8c50\u90d1', '2002.TW': '\u4e2d\u92fc', '2891.TW': '\u4e2d\u4fe1\u90d1', '1216.TW': '\u7d71\u4e00', 
    '2357.TW': '\u83ef\u78a9', '3231.TW': '\u7def\u5275', '2884.TW': '\u7309\u5c71\u90d1', '2885.TW': '\u5143\u5927\u90d1', 
    '2327.TW': '\u570b\u5de8', '2207.TW': '\u548c\u6cf0\u8eca', '1101.TW': '\u53f0\u6ce5', '2395.TW': '\u7814\u83ef', 
    '2408.TW': '\u5357\u4e9e\u79d1', '3034.TW': '\u806f\u8a60', '2892.TW': '\u7b2c\u4e00\u90d1', '2880.TW': '\u83ef\u5357\u90d1', 
    '5880.TW': '\u5408\u5eab\u90d1', '2883.TW': '\u51f1\u57fa\u90d1', '2890.TW': '\u6c38\u8c50\u90d1', '3045.TW': '\u53f0\u7063\u5927', 
...
new_content = re.sub(pattern, clean_name_map, content)

with open(file_path, 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Updated nameMap with Unicode escapes.")
